...
//         release the lock and give the other thread to run.
    ...
    void secondThread() throws InterruptedException {
        ...
        try {
            ...
            System.out.println("Does not releases the lock Immediately");
            l.unlock();
        }
...
class ReEntrantLockC31{
    public static void main(String[] args) throws InterruptedException {
        Concurrency_2_2 re = new Concurrency_2_2();
...
class ReadWriteReEntrantLockExC23{
...
class ReadWriteLockExC3{
    public static void main(String[] args) throws InterruptedException {
        ReadWriteReEntrantLockExC23 rle = new ReadWriteReEntrantLockExC23();
        Thread t1 = new Thread(() -> {
            try {
                rle.getCount();
            } catch (InterruptedException e) {
